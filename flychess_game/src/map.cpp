...
namespace flychess_map{
    Map::Map() {
        ...
        grids.push_back(Grid(static_cast<int>(GridType::TURN), grid_size * 5.5, grid_size, 7, grid_size, 3, 3));
        grids.push_back(Grid(static_cast<int>(GridType::BRIDGE), grid_size * 5.5, grid_size * 2, 10, grid_size, 0, 2));
        grids.push_back(Grid(static_cast<int>(GridType::BRIDGE), grid_size * 6.5, grid_size * 3, 11, grid_size, 2, 3));
        grids.push_back(Grid(static_cast<int>(GridType::TURN), map_size - grid_size, grid_size * 3, 14, grid_size, 3, 2));
        grids.push_back(Grid(static_cast<int>(GridType::TURN), map_size - grid_size, map_size - grid_size * 3, 20, grid_size, 0, 0));
        grids.push_back(Grid(static_cast<int>(GridType::BRIDGE), grid_size * 6.5, map_size - grid_size * 3, 23, grid_size, 1, 3));
        grids.push_back(Grid(static_cast<int>(GridType::BRIDGE), grid_size * 5.5, map_size - grid_size * 2, 24, grid_size, 3, 0));
        grids.push_back(Grid(static_cast<int>(GridType::TURN), grid_size * 5.5, map_size - grid_size, 27, grid_size, 0, 3));
        grids.push_back(Grid(static_cast<int>(GridType::TURN), grid_size * 3, map_size - grid_size, 33, grid_size, 1, 1));
        grids.push_back(Grid(static_cast<int>(GridType::BRIDGE), grid_size * 3, map_size - grid_size * 2, 36, grid_size, 2, 0));
        grids.push_back(Grid(static_cast<int>(GridType::BRIDGE), grid_size * 2, map_size - grid_size * 3, 37, grid_size, 0, 1));
        grids.push_back(Grid(static_cast<int>(GridType::TURN), grid_size, map_size - grid_size * 3, 40, grid_size, 1, 0));
        grids.push_back(Grid(static_cast<int>(GridType::TURN), grid_size, grid_size * 3, 46, grid_size, 2, 2));
        grids.push_back(Grid(static_cast<int>(GridType::BRIDGE), grid_size * 2, grid_size * 3, 49, grid_size, 3, 1));
        grids.push_back(Grid(static_cast<int>(GridType::BRIDGE), grid_size * 3, grid_size * 2, 50, grid_size, 1, 2));
